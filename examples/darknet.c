# 0 "examples/darknet.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "examples/darknet.c"
...
int main(int argc, char **argv)
{
    ...
    if(argc < 2){
        fprintf(
# 406 "examples/darknet.c" 3 4
               stderr
# 406 "examples/darknet.c"
                     , "usage: %s <function>\n", argv[0]);
        return 0;
    }
    ...
    if (0 == strcmp(argv[1], "average")){
        ...
        fprintf(
# 499 "examples/darknet.c" 3 4
               stderr
# 499 "examples/darknet.c"
                     , "Not an option: %s\n", argv[1]);
    }
    return 0;
}
