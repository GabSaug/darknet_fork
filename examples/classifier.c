# 0 "examples/classifier.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "examples/classifier.c"
...
# 5 "examples/classifier.c" 2


# 6 "examples/classifier.c"
...
void try_classifier(char *datacfg, char *cfgfile, char *weightfile, char *filename, int layer_num)
{
    ...
    while(1){
        if(filename){
            ...
            fflush(
# 505 "examples/classifier.c" 3 4
                  stdout
# 505 "examples/classifier.c"
                        );
            input = fgets(input, 256, 
# 506 "examples/classifier.c" 3 4
                                     stdin
# 506 "examples/classifier.c"
                                          );
            if(!input) return;
            strtok(input, "\n");
        }
...
void predict_classifier(char *datacfg, char *cfgfile, char *weightfile, char *filename, int top)
{
    ...
    while(1){
        if(filename){
            ...
            printf("Enter Image Path: ");
            fflush(
# 583 "examples/classifier.c" 3 4
                  stdout
# 583 "examples/classifier.c"
                        );
            input = fgets(input, 256, 
# 584 "examples/classifier.c" 3 4
                                     stdin
# 584 "examples/classifier.c"
                                          );
            if(!input) return;
            strtok(input, "\n");
        }
        ...
        fprintf(
# 600 "examples/classifier.c" 3 4
               stderr
# 600 "examples/classifier.c"
...
void csv_classifier(char *datacfg, char *cfgfile, char *weightfile)
{
    ...
    for(i = 0; i < m; ++i){
        ...
        fprintf(
# 685 "examples/classifier.c" 3 4
               stderr
# 685 "examples/classifier.c"
...
void test_classifier(char *datacfg, char *cfgfile, char *weightfile, int target_layer)
{
    ...
    for(curr = net->batch; curr < m; curr += net->batch){
        ...
        fprintf(
# 733 "examples/classifier.c" 3 4
               stderr
# 733 "examples/classifier.c"
        ...
        fprintf(
# 753 "examples/classifier.c" 3 4
               stderr
# 753 "examples/classifier.c"
...
{
# 917 "examples/classifier.c"
}


void gun_classifier(char *datacfg, char *cfgfile, char *weightfile, int cam_index, const char *filename)
{
# 984 "examples/classifier.c"
}

void demo_classifier(char *datacfg, char *cfgfile, char *weightfile, int cam_index, const char *filename)
{
# 1057 "examples/classifier.c"
}
...
void run_classifier(int argc, char **argv)
{
    if(argc < 4){
        fprintf(
# 1063 "examples/classifier.c" 3 4
               stderr
# 1063 "examples/classifier.c"
