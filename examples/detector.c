...
void validate_detector_flip(char *datacfg, char *cfgfile, char *weightfile, char *outfile)
{
    ...
    fprintf(
# 248 "examples/detector.c" 3 4
           stderr
# 248 "examples/detector.c"
    ...
    for(i = nthreads; i < m+nthreads; i += nthreads){
        fprintf(
# 314 "examples/detector.c" 3 4
               stderr
# 314 "examples/detector.c"
                     , "%d\n", i);
    ...
    if(coco){
        fseek(fp, -2, 
# 356 "examples/detector.c" 3 4
                     1
# 356 "examples/detector.c"
                             );
        fprintf(fp, "\n]\n");
        fclose(fp);
    }
    fprintf(
# 360 "examples/detector.c" 3 4
           stderr
# 360 "examples/detector.c"
...
void validate_detector(char *datacfg, char *cfgfile, char *weightfile, char *outfile)
{
    ...
    fprintf(
# 378 "examples/detector.c" 3 4
           stderr
# 378 "examples/detector.c"
                 , "Learning Rate: %g, Momentum: %g, Decay: %g\n", net->learning_rate, net->momentum, net->decay);
    srand(time(0));
    ...
    for(i = nthreads; i < m+nthreads; i += nthreads){
        fprintf(
# 443 "examples/detector.c" 3 4
               stderr
# 443 "examples/detector.c"
                     , "%d\n", i);
        for(t = 0; t < nthreads && i+t-nthreads < m; ++t){
            pthread_join(thr[t], 0);
            val[t] = buf[t];
    ...
    if(coco){
        fseek(fp, -2, 
# 482 "examples/detector.c" 3 4
                     1
# 482 "examples/detector.c"
                             );
        fprintf(fp, "\n]\n");
        fclose(fp);
    }
    fprintf(
# 486 "examples/detector.c" 3 4
           stderr
# 486 "examples/detector.c"
                 , "Total Detection Time: %f Seconds\n", what_time_is_it_now() - start);
}
...
void validate_detector_recall(char *cfgfile, char *weightfile)
{
    ...
    set_batch_network(net, 1);
    fprintf(
# 493 "examples/detector.c" 3 4
           stderr
# 493 "examples/detector.c"
                 , "Learning Rate: %g, Momentum: %g, Decay: %g\n", net->learning_rate, net->momentum, net->decay);
    srand(time(0));
    ...
    for(i = 0; i < m; ++i){
        ...
        fprintf(
# 554 "examples/detector.c" 3 4
               stderr
# 554 "examples/detector.c"
...
void test_detector(char *datacfg, char *cfgfile, char *weightfile, char *filename, float thresh, float hier_thresh, char *outfile, int fullscreen)
{
    ...
    while(1){
        if(filename){
            ...
            fflush(
# 581 "examples/detector.c" 3 4
                  stdout
# 581 "examples/detector.c"
                        );
            input = fgets(input, 256, 
# 582 "examples/detector.c" 3 4
                                     stdin
# 582 "examples/detector.c"
                                          );
            if(!input) return;
            strtok(input, "\n");
        }
...
void run_detector(int argc, char **argv)
{
    ...
    if(argc < 4){
        fprintf(
# 798 "examples/detector.c" 3 4
               stderr
# 798 "examples/detector.c"
