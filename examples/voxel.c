...
void test_voxel(char *cfgfile, char *weightfile, char *filename)
{
    ...
    while(1){
        if(filename){
            ...
            fflush(
# 123 "examples/voxel.c" 3 4
                  stdout
# 123 "examples/voxel.c"
                        );
            input = fgets(input, 256, 
# 124 "examples/voxel.c" 3 4
                                     stdin
# 124 "examples/voxel.c"
                                          );
            if(!input) return;
            strtok(input, "\n");
        }
...
void run_voxel(int argc, char **argv)
{
    if(argc < 4){
        fprintf(
# 148 "examples/voxel.c" 3 4
               stderr
# 148 "examples/voxel.c"
