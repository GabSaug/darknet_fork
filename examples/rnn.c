...
# 407 "examples/rnn.c"
    ...
    int in = 0;
    while(c != 
# 410 "examples/rnn.c" 3 4
              (-1)
# 410 "examples/rnn.c"
                 ){
        int next = getc(
# 411 "examples/rnn.c" 3 4
                       stdin
# 411 "examples/rnn.c"
                            );
        if(next == 
# 412 "examples/rnn.c" 3 4
                  (-1)
# 412 "examples/rnn.c"
                     ) break;
...
# 438 "examples/rnn.c"
    ...
    float sum = 0;
    c = getc(
# 456 "examples/rnn.c" 3 4
            stdin
# 456 "examples/rnn.c"
                 );
    float log2 = log(2);
    while(c != 
# 458 "examples/rnn.c" 3 4
              (-1)
# 458 "examples/rnn.c"
                 ){
        int next = getc(
# 459 "examples/rnn.c" 3 4
                       stdin
# 459 "examples/rnn.c"
                            );
        if(next == 
# 460 "examples/rnn.c" 3 4
                  (-1)
# 460 "examples/rnn.c"
                     ) break;
        if(next < 0 || next >= 255) error("Out of range character");
