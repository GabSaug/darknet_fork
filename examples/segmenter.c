# 0 "examples/segmenter.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "examples/segmenter.c"
...
# 4 "examples/segmenter.c" 2


# 5 "examples/segmenter.c"
...
# 30 "examples/segmenter.c" 3 4
   ((void) sizeof ((
# 30 "examples/segmenter.c"
   pred.w * div == net->w
# 30 "examples/segmenter.c" 3 4
...
# 30 "examples/segmenter.c"
   "pred.w * div == net->w"
# 30 "examples/segmenter.c" 3 4
   , "examples/segmenter.c", 30, __extension__ __PRETTY_FUNCTION__); }))
# 30 "examples/segmenter.c"
                                 ;
    
# 31 "examples/segmenter.c" 3 4
   ((void) sizeof ((
# 31 "examples/segmenter.c"
   pred.h * div == net->h
# 31 "examples/segmenter.c" 3 4
   ) ? 1 : 0), __extension__ ({ if (
# 31 "examples/segmenter.c"
...
# 31 "examples/segmenter.c"
   "pred.h * div == net->h"
# 31 "examples/segmenter.c" 3 4
   , "examples/segmenter.c", 31, __extension__ __PRETTY_FUNCTION__); }))
# 31 "examples/segmenter.c"
                                 ;
...
void predict_segmenter(char *datafile, char *cfg, char *weights, char *filename)
{
    ...
    while(1){
        if(filename){
            ...
            fflush(
# 145 "examples/segmenter.c" 3 4
                  stdout
# 145 "examples/segmenter.c"
                        );
            input = fgets(input, 256, 
# 146 "examples/segmenter.c" 3 4
                                     stdin
# 146 "examples/segmenter.c"
                                          );
            if(!input) return;
            strtok(input, "\n");
        }
...
void run_segmenter(int argc, char **argv)
{
    if(argc < 4){
        fprintf(
# 216 "examples/segmenter.c" 3 4
               stderr
# 216 "examples/segmenter.c"
