...
void test_yolo(char *cfgfile, char *weightfile, char *filename, float thresh)
{
    ...
    while(1){
        if(filename){
            ...
            fflush(
# 281 "examples/yolo.c" 3 4
                  stdout
# 281 "examples/yolo.c"
                        );
            input = fgets(input, 256, 
# 282 "examples/yolo.c" 3 4
                                     stdin
# 282 "examples/yolo.c"
                                          );
            if(!input) return;
