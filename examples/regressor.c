# 0 "examples/regressor.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "examples/regressor.c"
...
# 4 "examples/regressor.c" 2


# 5 "examples/regressor.c"
...
void predict_regressor(char *cfgfile, char *weightfile, char *filename)
{
    ...
    while(1){
        if(filename){
            ...
            fflush(
# 130 "examples/regressor.c" 3 4
                  stdout
# 130 "examples/regressor.c"
                        );
            input = fgets(input, 256, 
# 131 "examples/regressor.c" 3 4
                                     stdin
# 131 "examples/regressor.c"
                                          );
            if(!input) return;
            strtok(input, "\n");
        }
...
void run_regressor(int argc, char **argv)
{
    if(argc < 4){
        fprintf(
# 202 "examples/regressor.c" 3 4
               stderr
# 202 "examples/regressor.c"
