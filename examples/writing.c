# 0 "examples/writing.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "examples/writing.c"
...
void test_writing(char *cfgfile, char *weightfile, char *filename)
{
    ...
    while(1){
        if(filename){
            ...
            fflush(
# 98 "examples/writing.c" 3 4
                  stdout
# 98 "examples/writing.c"
                        );
            input = fgets(input, 256, 
# 99 "examples/writing.c" 3 4
                                     stdin
# 99 "examples/writing.c"
                                          );
            if(!input) return;
            strtok(input, "\n");
        }
...
void run_writing(int argc, char **argv)
{
    if(argc < 4){
        fprintf(
# 134 "examples/writing.c" 3 4
               stderr
# 134 "examples/writing.c"
