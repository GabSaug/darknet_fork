# 0 "examples/instance-segmenter.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "examples/instance-segmenter.c"
...
# 2 "examples/instance-segmenter.c" 2
...
# 3 "examples/instance-segmenter.c" 2
...
# 4 "examples/instance-segmenter.c" 2


# 5 "examples/instance-segmenter.c"
...
# 35 "examples/instance-segmenter.c" 3 4
   ((void) sizeof ((
# 35 "examples/instance-segmenter.c"
   pred.w * div == net->w
# 35 "examples/instance-segmenter.c" 3 4
...
# 35 "examples/instance-segmenter.c"
   "pred.w * div == net->w"
# 35 "examples/instance-segmenter.c" 3 4
   , "examples/instance-segmenter.c", 35, __extension__ __PRETTY_FUNCTION__); }))
# 35 "examples/instance-segmenter.c"
                                 ;
    
# 36 "examples/instance-segmenter.c" 3 4
   ((void) sizeof ((
# 36 "examples/instance-segmenter.c"
   pred.h * div == net->h
# 36 "examples/instance-segmenter.c" 3 4
   ) ? 1 : 0), __extension__ ({ if (
# 36 "examples/instance-segmenter.c"
...
# 36 "examples/instance-segmenter.c"
   "pred.h * div == net->h"
# 36 "examples/instance-segmenter.c" 3 4
   , "examples/instance-segmenter.c", 36, __extension__ __PRETTY_FUNCTION__); }))
# 36 "examples/instance-segmenter.c"
                                 ;
...
void predict_isegmenter(char *datafile, char *cfg, char *weights, char *filename)
{
    ...
    while(1){
        if(filename){
            ...
            fflush(
# 157 "examples/instance-segmenter.c" 3 4
                  stdout
# 157 "examples/instance-segmenter.c"
                        );
            input = fgets(input, 256, 
# 158 "examples/instance-segmenter.c" 3 4
                                     stdin
# 158 "examples/instance-segmenter.c"
                                          );
            if(!input) return;
            strtok(input, "\n");
        }
...
{
# 222 "examples/instance-segmenter.c"
}
...
void run_isegmenter(int argc, char **argv)
{
    if(argc < 4){
        fprintf(
# 228 "examples/instance-segmenter.c" 3 4
               stderr
# 228 "examples/instance-segmenter.c"
