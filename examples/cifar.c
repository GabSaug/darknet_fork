...
void test_cifar_csv(char *filename, char *weightfile)
{
    ...
    matrix_to_csv(pred);
    fprintf(
# 191 "examples/cifar.c" 3 4
           stderr
# 191 "examples/cifar.c"
...
void test_cifar_csvtrain(char *cfg, char *weights)
{
    ...
    matrix_to_csv(pred);
    fprintf(
# 215 "examples/cifar.c" 3 4
           stderr
# 215 "examples/cifar.c"
                 , "Accuracy: %f\n", matrix_topk_accuracy(test.y, pred, 1));
    free_data(test);
}
...
void eval_cifar_csv()
{
    ...
    fprintf(
# 224 "examples/cifar.c" 3 4
           stderr
# 224 "examples/cifar.c"
                 , "%d %d\n", pred.rows, pred.cols);

    fprintf(
# 226 "examples/cifar.c" 3 4
           stderr
# 226 "examples/cifar.c"
                 , "Accuracy: %f\n", matrix_topk_accuracy(test.y, pred, 1));
    free_data(test);
    free_matrix(pred);
}
...
void run_cifar(int argc, char **argv)
{
    if(argc < 4){
        fprintf(
# 235 "examples/cifar.c" 3 4
               stderr
# 235 "examples/cifar.c"
