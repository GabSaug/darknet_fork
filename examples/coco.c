...
void test_coco(char *cfgfile, char *weightfile, char *filename, float thresh)
{
    ...
    while(1){
        if(filename){
            ...
            fflush(
# 310 "examples/coco.c" 3 4
                  stdout
# 310 "examples/coco.c"
                        );
            input = fgets(input, 256, 
# 311 "examples/coco.c" 3 4
                                     stdin
# 311 "examples/coco.c"
                                          );
            if(!input) return;
