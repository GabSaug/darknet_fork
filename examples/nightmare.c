# 0 "examples/nightmare.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "examples/nightmare.c"
...
# 4 "examples/nightmare.c" 2




# 7 "examples/nightmare.c"
...
# 288 "examples/nightmare.c"
void run_nightmare(int argc, char **argv)
{
    srand(0);
    if(argc < 4){
        fprintf(
# 292 "examples/nightmare.c" 3 4
               stderr
# 292 "examples/nightmare.c"
...
# 365 "examples/nightmare.c"
    ...
    for(e = 0; e < rounds; ++e){
        fprintf(
# 371 "examples/nightmare.c" 3 4
               stderr
# 371 "examples/nightmare.c"
                     , "Iteration: ");
        fflush(
# 372 "examples/nightmare.c" 3 4
              stderr
# 372 "examples/nightmare.c"
                    );
        for(n = 0; n < iters; ++n){
            fprintf(
# 374 "examples/nightmare.c" 3 4
                   stderr
# 374 "examples/nightmare.c"
                         , "%d, ", n);
            fflush(
# 375 "examples/nightmare.c" 3 4
                  stderr
# 375 "examples/nightmare.c"
                        );
            if(reconstruct){
        ...
        fprintf(
# 386 "examples/nightmare.c" 3 4
               stderr
# 386 "examples/nightmare.c"
                     , "done\n");
        if(0){
