# 0 "src/logistic_layer.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "src/logistic_layer.c"
# 1 "src/logistic_layer.h" 1
...
# 11 "src/logistic_layer.c" 2


# 12 "src/logistic_layer.c"
layer make_logistic_layer(int batch, int inputs)
{
    fprintf(
# 14 "src/logistic_layer.c" 3 4
           stderr
# 14 "src/logistic_layer.c"
