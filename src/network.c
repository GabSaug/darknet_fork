...
# 1 "src/crop_layer.h" 1




# 1 "src/layer.h" 1
# 6 "src/crop_layer.h" 2
...
# 11 "src/network.c" 2
# 1 "src/connected_layer.h" 1



# 1 "src/activations.h" 1



# 1 "src/cuda.h" 1
# 5 "src/activations.h" 2
...
# 5 "src/connected_layer.h" 2
# 1 "src/layer.h" 1
# 6 "src/connected_layer.h" 2
...
# 1 "src/layer.h" 1
# 8 "src/local_layer.h" 2


typedef layer local_layer;
# 21 "src/local_layer.h"
...
# 1 "src/layer.h" 1
# 8 "src/convolutional_layer.h" 2


typedef layer convolutional_layer;
# 28 "src/convolutional_layer.h"
...
# 17 "src/network.c" 2
# 1 "src/activation_layer.h" 1




# 1 "src/layer.h" 1
# 6 "src/activation_layer.h" 2
...
# 18 "src/network.c" 2
# 1 "src/detection_layer.h" 1



# 1 "src/layer.h" 1
# 5 "src/detection_layer.h" 2
...
# 19 "src/network.c" 2
# 1 "src/region_layer.h" 1




# 1 "src/layer.h" 1
# 6 "src/region_layer.h" 2
...
# 20 "src/network.c" 2
# 1 "src/yolo_layer.h" 1




# 1 "src/layer.h" 1
# 6 "src/yolo_layer.h" 2
...
# 21 "src/network.c" 2
# 1 "src/normalization_layer.h" 1




# 1 "src/layer.h" 1
# 6 "src/normalization_layer.h" 2
...
# 22 "src/network.c" 2
# 1 "src/batchnorm_layer.h" 1




# 1 "src/layer.h" 1
# 6 "src/batchnorm_layer.h" 2
...
# 26 "src/network.c" 2
# 1 "src/cost_layer.h" 1


# 1 "src/layer.h" 1
# 4 "src/cost_layer.h" 2
...
# 27 "src/network.c" 2
# 1 "src/softmax_layer.h" 1


# 1 "src/layer.h" 1
# 4 "src/softmax_layer.h" 2
...
# 28 "src/network.c" 2
# 1 "src/dropout_layer.h" 1



# 1 "src/layer.h" 1
# 5 "src/dropout_layer.h" 2
...
# 29 "src/network.c" 2
# 1 "src/route_layer.h" 1



# 1 "src/layer.h" 1
# 5 "src/route_layer.h" 2
...
# 31 "src/network.c" 2
# 1 "src/shortcut_layer.h" 1



# 1 "src/layer.h" 1
# 5 "src/shortcut_layer.h" 2
...
# 316 "src/network.c" 3 4
   ((void) sizeof ((
# 316 "src/network.c"
   d.X.rows % net->batch == 0
# 316 "src/network.c" 3 4
...
# 316 "src/network.c"
   "d.X.rows % net->batch == 0"
# 316 "src/network.c" 3 4
   , "src/network.c", 316, __extension__ __PRETTY_FUNCTION__); }))
# 316 "src/network.c"
                                     ;
    int batch = net->batch;
...
# 402 "src/network.c"
                                         "0"
# 402 "src/network.c" 3 4
                                         , "src/network.c", 402, __extension__ __PRETTY_FUNCTION__); }))
# 402 "src/network.c"
                                                  ;
        inputs = l.outputs;
        net->layers[i] = l;
...
void print_network(network *net)
{
    ...
    for(i = 0; i < net->n; ++i){
        ...
        fprintf(
# 648 "src/network.c" 3 4
               stderr
# 648 "src/network.c"
                     , "Layer %d - Mean: %f, Variance: %f\n",i,mean, vari);
        if(n > 100) n = 100;
        for(j = 0; j < n; ++j) fprintf(
# 650 "src/network.c" 3 4
                                      stderr
# 650 "src/network.c"
                                            , "%f, ", output[j]);
        if(n == 100)fprintf(
# 651 "src/network.c" 3 4
                           stderr
# 651 "src/network.c"
                                 ,".....\n");
        fprintf(
# 652 "src/network.c" 3 4
               stderr
# 652 "src/network.c"
                     , "\n");
    }
