# 0 "src/softmax_layer.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "src/softmax_layer.c"
...
# 3 "src/softmax_layer.c" 2
# 1 "src/cuda.h" 1
# 4 "src/softmax_layer.c" 2
...
# 10 "src/softmax_layer.c" 2


# 11 "src/softmax_layer.c"
softmax_layer make_softmax_layer(int batch, int inputs, int groups)
{
    
# 13 "src/softmax_layer.c" 3 4
   ((void) sizeof ((
# 13 "src/softmax_layer.c"
   inputs%groups == 0
# 13 "src/softmax_layer.c" 3 4
...
# 13 "src/softmax_layer.c"
   "inputs%groups == 0"
# 13 "src/softmax_layer.c" 3 4
   , "src/softmax_layer.c", 13, __extension__ __PRETTY_FUNCTION__); }))
# 13 "src/softmax_layer.c"
                             ;
    fprintf(
# 14 "src/softmax_layer.c" 3 4
           stderr
# 14 "src/softmax_layer.c"
                 , "softmax                                        %4d\n", inputs);
    softmax_layer l = {0};
    l.type = SOFTMAX;
    l.batch = batch;
