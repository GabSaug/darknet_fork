...
# 2 "src/route_layer.c" 2
# 1 "src/cuda.h" 1
# 3 "src/route_layer.c" 2
# 1 "src/blas.h" 1
...
# 9 "src/route_layer.c"
    ...
    for(i = 0; i < n; ++i){
        fprintf(
# 19 "src/route_layer.c" 3 4
               stderr
# 19 "src/route_layer.c"
                     ," %d", input_layers[i]);
        outputs += input_sizes[i];
    }
    fprintf(
# 22 "src/route_layer.c" 3 4
           stderr
# 22 "src/route_layer.c"
                 , "\n");
    l.outputs = outputs;
    l.inputs = outputs;
