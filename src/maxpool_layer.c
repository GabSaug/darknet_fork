# 0 "src/maxpool_layer.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "src/maxpool_layer.c"
...
maxpool_layer make_maxpool_layer(int batch, int h, int w, int c, int size, int stride, int padding)
{
    ...
    fprintf(
# 50 "src/maxpool_layer.c" 3 4
           stderr
# 50 "src/maxpool_layer.c"
                    ...
                    for(n = 0; n < l.size; ++n){
                        for(m = 0; m < l.size; ++m){
                            ...
                            int valid = (cur_h >= 0 && cur_h < l.h &&
                                         cur_w >= 0 && cur_w < l.w);
                            float val = (valid != 0) ? net.input[index] : -3.40282346638528859811704183484516925e+38F
# 103 "src/maxpool_layer.c"
                                                                                 ;
