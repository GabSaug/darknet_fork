# 0 "src/avgpool_layer.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "src/avgpool_layer.c"
...
# 5 "src/avgpool_layer.h" 2
# 1 "src/cuda.h" 1
# 6 "src/avgpool_layer.h" 2
# 1 "src/layer.h" 1
...
{
    fprintf(
# 7 "src/avgpool_layer.c" 3 4
           stderr
# 7 "src/avgpool_layer.c"
                 , "avg                     %4d x%4d x%4d   ->  %4d\n", w, h, c, c);
    avgpool_layer l = {0};
    l.type = AVGPOOL;
    l.batch = batch;
