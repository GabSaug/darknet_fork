...
# 3 "src/cost_layer.c" 2
# 1 "src/cuda.h" 1
# 4 "src/cost_layer.c" 2
# 1 "src/blas.h" 1
...
void forward_cost_layer(cost_layer l, network net)
{
    ...
    if(l.cost_type == MASKED){
        ...
        for(i = 0; i < l.batch*l.inputs; ++i){
            if(net.truth[i] == -1234) net.input[i] = -1234;
        }
    }
