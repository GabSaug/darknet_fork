# 0 "src/shortcut_layer.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "src/shortcut_layer.c"
...
# 6 "src/shortcut_layer.h" 2

layer make_shortcut_layer(int batch, int index, int w, int h, int c, int w2, int h2, int c2);
void forward_shortcut_layer(const layer l, network net);
void backward_shortcut_layer(const layer l, network net);
void resize_shortcut_layer(layer *l, int w, int h);
# 2 "src/shortcut_layer.c" 2
# 1 "src/cuda.h" 1
# 3 "src/shortcut_layer.c" 2
# 1 "src/blas.h" 1
...
# 8 "src/shortcut_layer.c" 2


# 9 "src/shortcut_layer.c"
layer make_shortcut_layer(int batch, int index, int w, int h, int c, int w2, int h2, int c2)
{
    fprintf(
# 11 "src/shortcut_layer.c" 3 4
           stderr
# 11 "src/shortcut_layer.c"
...
# 43 "src/shortcut_layer.c" 3 4
   ((void) sizeof ((
# 43 "src/shortcut_layer.c"
   l->w == l->out_w
# 43 "src/shortcut_layer.c" 3 4
...
# 43 "src/shortcut_layer.c"
   "l->w == l->out_w"
# 43 "src/shortcut_layer.c" 3 4
   , "src/shortcut_layer.c", 43, __extension__ __PRETTY_FUNCTION__); }))
# 43 "src/shortcut_layer.c"
                           ;
    
# 44 "src/shortcut_layer.c" 3 4
   ((void) sizeof ((
# 44 "src/shortcut_layer.c"
   l->h == l->out_h
# 44 "src/shortcut_layer.c" 3 4
   ) ? 1 : 0), __extension__ ({ if (
# 44 "src/shortcut_layer.c"
...
# 44 "src/shortcut_layer.c"
   "l->h == l->out_h"
# 44 "src/shortcut_layer.c" 3 4
   , "src/shortcut_layer.c", 44, __extension__ __PRETTY_FUNCTION__); }))
# 44 "src/shortcut_layer.c"
                           ;
    l->w = l->out_w = w;
    l->h = l->out_h = h;
