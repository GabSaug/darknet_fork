# 0 "src/deconvolutional_layer.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "src/deconvolutional_layer.c"
# 1 "src/deconvolutional_layer.h" 1
...
# 5 "src/cuda.h" 2
# 5 "src/deconvolutional_layer.h" 2
# 1 "src/image.h" 1
...
# 6 "src/deconvolutional_layer.h" 2
...
# 7 "src/deconvolutional_layer.h" 2
# 1 "src/layer.h" 1
# 8 "src/deconvolutional_layer.h" 2
# 1 "src/network.h" 1
...
# 3 "src/deconvolutional_layer.c" 2
...
# 4 "src/deconvolutional_layer.c" 2
# 1 "src/utils.h" 1
# 17 "src/utils.h"
double what_time_is_it_now();
...
# 5 "src/deconvolutional_layer.c" 2
# 1 "src/im2col.h" 1
...
# 6 "src/deconvolutional_layer.c" 2
# 1 "src/col2im.h" 1
...
# 7 "src/deconvolutional_layer.c" 2
# 1 "src/blas.h" 1
...
# 8 "src/deconvolutional_layer.c" 2
# 1 "src/gemm.h" 1
...
void gemm_cpu(int TA, int TB, int M, int N, int K, float ALPHA,
        ...
        float BETA,
        float *C, int ldc);
# 9 "src/deconvolutional_layer.c" 2
...
# 160 "src/deconvolutional_layer.c"
    l.activation = activation;
    l.workspace_size = get_workspace_size(l);

    fprintf(
# 163 "src/deconvolutional_layer.c" 3 4
           stderr
# 163 "src/deconvolutional_layer.c"
...
# 219 "src/deconvolutional_layer.c"
    l->workspace_size = get_workspace_size(*l);
}
