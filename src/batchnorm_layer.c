# 0 "src/batchnorm_layer.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "src/batchnorm_layer.c"
...
# 4 "src/batchnorm_layer.c" 2


layer make_batchnorm_layer(int batch, int w, int h, int c)
{
    fprintf(
# 8 "src/batchnorm_layer.c" 3 4
           stderr
# 8 "src/batchnorm_layer.c"
...
{
    fprintf(
# 132 "src/batchnorm_layer.c" 3 4
           stderr
# 132 "src/batchnorm_layer.c"
                 , "Not implemented\n");
}
