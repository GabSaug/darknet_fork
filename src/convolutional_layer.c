# 0 "src/convolutional_layer.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "src/convolutional_layer.c"
...
# 118 "src/convolutional_layer.c"
    return (size_t)l.out_h*l.out_w*l.size*l.size*l.c/l.groups*sizeof(float);
}
# 176 "src/convolutional_layer.c"
convolutional_layer make_convolutional_layer(int batch, int h, int w, int c, int n, int groups, int size, int stride, int padding, ACTIVATION activation, int batch_normalize, int binary, int xnor, int adam)
{
    int i;
...
# 322 "src/convolutional_layer.c"
    l.workspace_size = get_workspace_size(l);
    l.activation = activation;

    fprintf(
# 325 "src/convolutional_layer.c" 3 4
           stderr
# 325 "src/convolutional_layer.c"
