# 0 "src/connected_layer.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "src/connected_layer.c"
...
# 127 "src/connected_layer.c"
    l.activation = activation;
    fprintf(
# 128 "src/connected_layer.c" 3 4
           stderr
# 128 "src/connected_layer.c"
                 , "connected                            %4d  ->  %4d\n", inputs, outputs);
    return l;
}
