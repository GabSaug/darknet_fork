# 0 "src/normalization_layer.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "src/normalization_layer.c"
...
{
    fprintf(
# 8 "src/normalization_layer.c" 3 4
           stderr
# 8 "src/normalization_layer.c"
