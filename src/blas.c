...
# 72 "src/blas.c"
   "stride == h1/h2"
# 72 "src/blas.c" 3 4
   , "src/blas.c", 72, __extension__ __PRETTY_FUNCTION__); }))
# 72 "src/blas.c"
                          ;
...
# 73 "src/blas.c"
   "sample == h2/h1"
# 73 "src/blas.c" 3 4
   , "src/blas.c", 73, __extension__ __PRETTY_FUNCTION__); }))
# 73 "src/blas.c"
                          ;
...
void softmax(float *input, int n, float temp, int stride, float *output)
{
    int i;
    float sum = 0;
    float largest = -3.40282346638528859811704183484516925e+38F
# 309 "src/blas.c"
                           ;
    for(i = 0; i < n; ++i){
