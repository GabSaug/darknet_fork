# 0 "src/l2norm_layer.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "src/l2norm_layer.c"
# 1 "src/l2norm_layer.h" 1
...
# 11 "src/l2norm_layer.c" 2


# 12 "src/l2norm_layer.c"
layer make_l2norm_layer(int batch, int inputs)
{
    fprintf(
# 14 "src/l2norm_layer.c" 3 4
           stderr
# 14 "src/l2norm_layer.c"
                 , "l2norm                                         %4d\n", inputs);
    layer l = {0};
    l.type = L2NORM;
    l.batch = batch;
