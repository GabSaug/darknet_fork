# 0 "src/dropout_layer.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "src/dropout_layer.c"
...
# 3 "src/dropout_layer.c" 2
# 1 "src/cuda.h" 1
# 4 "src/dropout_layer.c" 2
...
dropout_layer make_dropout_layer(int batch, int inputs, float probability)
{
    ...
    fprintf(
# 24 "src/dropout_layer.c" 3 4
           stderr
# 24 "src/dropout_layer.c"
