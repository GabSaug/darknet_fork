# 0 "src/activation_layer.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "src/activation_layer.c"
...
# 7 "src/activation_layer.h" 2

layer make_activation_layer(int batch, int inputs, ACTIVATION activation);

void forward_activation_layer(layer l, network net);
void backward_activation_layer(layer l, network net);
# 2 "src/activation_layer.c" 2
# 1 "src/utils.h" 1
# 17 "src/utils.h"
double what_time_is_it_now();
...
layer make_activation_layer(int batch, int inputs, ACTIVATION activation)
{
    ...
    fprintf(
# 34 "src/activation_layer.c" 3 4
           stderr
# 34 "src/activation_layer.c"
