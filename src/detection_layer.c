# 0 "src/detection_layer.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "src/detection_layer.c"
...
# 11 "src/detection_layer.c" 2




# 14 "src/detection_layer.c"
...
# 28 "src/detection_layer.c" 3 4
   ((void) sizeof ((
# 28 "src/detection_layer.c"
   side*side*((1 + l.coords)*l.n + l.classes) == inputs
# 28 "src/detection_layer.c" 3 4
...
# 28 "src/detection_layer.c"
   "side*side*((1 + l.coords)*l.n + l.classes) == inputs"
# 28 "src/detection_layer.c" 3 4
   , "src/detection_layer.c", 28, __extension__ __PRETTY_FUNCTION__); }))
# 28 "src/detection_layer.c"
                                                               ;
    ...
    fprintf(
# 44 "src/detection_layer.c" 3 4
           stderr
# 44 "src/detection_layer.c"
                 , "Detection Layer\n");
    srand(0);
