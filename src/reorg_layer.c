...
# 5 "src/reorg_layer.h" 2
# 1 "src/cuda.h" 1
# 6 "src/reorg_layer.h" 2
# 1 "src/layer.h" 1
...
layer make_reorg_layer(int batch, int w, int h, int c, int stride, int reverse, int flatten, int extra)
{
    ...
    if(extra){
        fprintf(
# 38 "src/reorg_layer.c" 3 4
               stderr
# 38 "src/reorg_layer.c"
                     , "reorg              %4d   ->  %4d\n", l.inputs, l.outputs);
    } else {
        fprintf(
# 40 "src/reorg_layer.c" 3 4
               stderr
# 40 "src/reorg_layer.c"
