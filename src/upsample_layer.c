# 0 "src/upsample_layer.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "src/upsample_layer.c"
...
# 4 "src/upsample_layer.h" 2

layer make_upsample_layer(int batch, int w, int h, int c, int stride);
void forward_upsample_layer(const layer l, network net);
void backward_upsample_layer(const layer l, network net);
void resize_upsample_layer(layer *l, int w, int h);
# 2 "src/upsample_layer.c" 2
# 1 "src/cuda.h" 1
# 3 "src/upsample_layer.c" 2
# 1 "src/blas.h" 1
...
layer make_upsample_layer(int batch, int w, int h, int c, int stride)
{
    ...
    if(l.reverse) fprintf(
# 39 "src/upsample_layer.c" 3 4
                         stderr
# 39 "src/upsample_layer.c"
                               , "downsample         %2dx  %4d x%4d x%4d   ->  %4d x%4d x%4d\n", stride, w, h, c, l.out_w, l.out_h, l.out_c);
    else fprintf(
# 40 "src/upsample_layer.c" 3 4
                stderr
# 40 "src/upsample_layer.c"
